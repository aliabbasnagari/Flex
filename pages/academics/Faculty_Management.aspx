<%@ Page Title="" Language="C#" MasterPageFile="~/masters/Academics_Profile.Master" AutoEventWireup="true" CodeBehind="Faculty_Management.aspx.cs" Inherits="Flex.pages.academics.Faculty_Management" %>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <div class="d-flex" role="search">
                                <asp:TextBox runat="server" ID="searchEmail" CssClass="form-control me-2" placeholder="NU Email" Required="true"></asp:TextBox>
                                <asp:LinkButton ID="SearchFaculty" runat="server" CssClass="btn btn-secondary rounded-5" OnClick="SearchFaculty_Click">
